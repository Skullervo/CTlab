function s = spectrum(energy, varargin)
...
if isempty(varargin) == 1
    sB = spektrBeers(MICSspect, [13 inherentTASMIPfilt]);
    q = normalizationFactor(fix(energy)) .* sB;
            ...
            if alFiltAndRipple(1,2)== 0
                ...
                if useTASMICS == 0
                    ...
                    if normalize == 1
                        ...
                        q = normalizationFactor(round(energy)) * q;
                    end
                end
            else               
