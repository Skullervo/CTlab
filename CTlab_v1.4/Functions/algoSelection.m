function opt=algoSelection
hfig=figure('Name','Reconstruction Algorithm','NumberTitle','off','CloseRequestFcn',@close_req_fun,'menu','none'); %,'Color',[0.25,0.44,0.68]
...
opt_list={'Filtered backprojection (FBP)','Least squares','Tikhonov Regularization', 'Gradient Descent'};
defaultans='Filtered backprojection (FBP)';
%set defaults
% str1=defaultans;
% str2=defaultans;
% opt=opt_list{1};
...
uicontrol('Style', 'pushbutton', 'String', 'OK', ...
    'Parent',hfig,'Units','Normalized', ...
    'Position', [.1 .1 .35 .2],...
    'Callback','close(gcbf)'); %,'BackgroundColor',[0.76,0.89,1.00]
